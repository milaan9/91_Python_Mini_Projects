...
<a href="https://hits.seeyoufarm.com"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fmilaan9%2F/tree/main/014_Built_Translator&count_bg=%231DC92C&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=views&edge_flat=false"/></a>
</p> 
...
In this class, you'll learn how to built translator using python.                                                        


## Prerequisites:

1.  <b> Python Basics </b>
2.  <b> googletrans module </b>
...
**[`Googletrans`](https://py-googletrans.readthedocs.io/en/latest/)** is a free and unlimited python library that implemented Google Translate API. This uses the **[Google Translate Ajax](https://translate.google.com/)** API to make calls to such methods as detect and translate.

* Fast and reliable - it uses the same servers that **[translate.google.com](http://translate.google.com/)** uses
